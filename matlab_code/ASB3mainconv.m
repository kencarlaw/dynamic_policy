...
hold on
box on
plot(RR(37:44),log10(elsc(37:44)),'Color','k','LineStyle','-','LineWidth',1.5)
plot(RR(37:44),log10(elsu(37:44)),'Color','k','LineStyle','--','LineWidth',1.5)
title('Pane l: Persistence of the q-attractors')
legend('log_{10} of ED in GB','log_{10} of ED in BB','Location','NorthEast')
legend boxoff
xlim([36 43])
xticks([36 37 38 39 40 41 42 43])
hold off
nexttile([1 5])
hold on
box on
plot(RR(37:44),pc(37:44),'Color','k','LineStyle','-','LineWidth',1.5)
plot(RR(37:44),pu(37:44),'Color','k','LineStyle','--','LineWidth',1.5)
title('Panel 2: Time spent in q-attractors') 
legend('Persistence, GB','Persistence, BB','Location','east')
legend boxoff
xlim([36 43])
xticks([36 37 38 39 40 41 42 43])
hold off
...
nexttile ([3 1])
hold on
plot(RR,mq,'Color','k','LineStyle','-','LineWidth',0.5)
%plot(RR,mov,'Color','k','LineStyle','--','LineWidth',0.5) 
box on
ylabel('Number of violations')
title('Panel 1: Expected violations in the estimated stationary distribution')
...
nexttile ([1 1])
hold on
plot(RR,corqp,'Color','k')
box on
xlabel('Enforcement resources (R)')
title('Panel 1: Correlation between obj. and subj. probabilities')
hold off
nexttile([1 1])
hold on
plot(RR, mA,'Color','k')
plot(RR, mq,'Color','k','LineStyle','--')
box on
title('Panel 2: Probabiliites')
xlabel('Deterrence resources (R)')
legend('Objective prob.','Subjective prob.','Location','best')
legend boxoff
hold off
nexttile([1 1])
hold on
plot(RR, mA-mq,'Color','k')
box on
title('Panel 3: Differnce between probs p - q')
xlabel('Enforcement resources (R)')
%legend('Objective prob.','Subjective prob.','Location','best')
%legend boxoff
hold off
