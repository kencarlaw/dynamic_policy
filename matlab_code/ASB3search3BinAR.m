...
lam=5;     %social cost conversion of individual ASB for social damage function
rho=2;
SWrho=5*rho;
mm=0;
...
for m=1:MC
    ...
    BE=round(unifrnd(Bmin,Bmax));
    BE2=round(unifrnd(BE,Bmax));
            ...
            while ((cc<1) && (b<MM))
                ...
                for t=1:Block
                    ...
                    if t>1
                        if q(t)>BinE(i)/(2*N)
                            R(t)=Rgb;
                        elseif (BinE(i)/(2*N)>=q(t))&&(q(t)>BE2/(2*N))
                            R(t)=Rtb;
                        elseif BE2/(2*N)>=q(t)
                            R(t)=Rbb;
                        end
            ...
            while ((cc<1) && (b<MM))
                ...
                for t=1:Block
                    ...
                    if t>1
                        if q(t)>BE/(2*N)
                            R(t)=Rgb;
                        elseif (BE/(2*N)>=q(t))&&(q(t)>BinE2(i)/(2*N))
                            R(t)=Rtb;
                        elseif BinE2(i)/(2*N)>=q(t)
                            R(t)=Rbb;
                        end
                        if R(t)~=R(t-1)
                            swi(t)=abs(Rbb-Rgb); 
...
OPTBB=[BnE1/(2*N) BnE2/(2*N) RRRgb RRRtb RRRbb CM];

%save('C:\Users\kcarlaw\Documents\MATLAB\ASB2023postRED\OPTBB2.txt','OPTBB','-ascii')